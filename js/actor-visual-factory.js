...
export const GameActorVisualFactory = {};
...
GameActorVisualFactory.create = function create(opts) {
  opts = opts || {};
  ...
  var visual = null;
  var rigApi = null;
  if (GameAvatarRig && GameAvatarRig.create) {
    rigApi = GameAvatarRig.create(String(opts.kind || ownerType), {
      bodyColor: bodyColor,
      skinColor: skinColor,
      legColor: legColor,
      weaponId: weaponId
  ...
  var bodyHitbox = createCombatHitbox('body', ownerType, {
    opacity: hitboxOpacity,
    targetId: targetId,
    netEntityId: netEntityId
  });
  var headHitbox = createCombatHitbox('head', ownerType, {
    opacity: hitboxOpacity,
    targetId: targetId,
    netEntityId: netEntityId
  });
