(function () {
    ...
    function gunVisual(definition) {
        ...
        return {
            ...
            anchors: {
                handle: visual.handlePos || (visual.grip && visual.grip.p ? visual.grip.p : DEFAULT_HANDLE),
                barrelTip: visual.barrelTipPos || visual.muzzlePos || DEFAULT_BARREL_TIP,
                support: visual.supportPos || [0, -0.01, (visual.barrel && visual.barrel.p ? visual.barrel.p[2] * 0.6 : -0.28)]
            },
            effects: {
                muzzleFlash: {
                    position: visual.muzzlePos || visual.barrelTipPos || DEFAULT_BARREL_TIP
                }
            }
        };
    }
    ...
    function buildEntries() {
        ...
        return {
            ...
            seekergun: {
                family: 'seekerProjectile',
                stats: stats.seekergun || null,
                visual: gunVisual({
                    gunPos: [0.0, 0.03, 0.06],
                    gunRot: [0.02, 0.02, 0],
