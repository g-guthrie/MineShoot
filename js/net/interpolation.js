...
(function () {
    ...
    function cloneTransform(entry) {
        ...
        return {
            ...
            fastBackpedal: !!entry.fastBackpedal,
    ...
    function blendTransforms(from, to, t) {
        ...
        return {
            ...
            fastBackpedal: alpha >= 0.5 ? !!to.fastBackpedal : !!from.fastBackpedal,
    ...
    function interpolateBufferedTransform(render, nowMs, options) {
        ...
        return {
            ...
            fastBackpedal: !!last.fastBackpedal,
    ...
    function _lerpEntries(older, newer, t) {
        ...
        return {
            ...
            fastBackpedal: !!choosePresentationValue(!!older.fastBackpedal, !!newer.fastBackpedal, t),
