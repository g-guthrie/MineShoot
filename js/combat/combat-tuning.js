...
(function () {
    ...
    var DEFAULTS = {
        ...
        classAbilities: {
            ...
            chokeRange: sharedAbilityDefault('choke', 'range', 26),
            chokeTargetTolerance: sharedAbilityDefault('choke', 'targetTolerance', 1.35),
            chokeDuration: sharedAbilityDefault('choke', 'duration', 1.25),
            chokeLiftHeight: sharedAbilityDefault('choke', 'liftHeight', 1.6),
            ...
            hookLockBoxPx: sharedAbilityDefault('hook', 'lockBoxPx', 150),
            hookReticleRadiusPx: sharedAbilityDefault('hook', 'reticleRadiusPx', 68),
            hookRange: sharedAbilityDefault('hook', 'range', 22),
            hookCastDamage: sharedAbilityDefault('hook', 'castDamage', 20),
            hookStunDuration: sharedAbilityDefault('hook', 'stunDuration', 0.5),
            hookPullDistance: sharedAbilityDefault('hook', 'pullDistance', 4.0),
            hookCatchRadius: sharedAbilityDefault('hook', 'catchRadius', 1.8),
            hookTravelSpeed: sharedAbilityDefault('hook', 'travelSpeed', 26),
            hookPullSpeed: sharedAbilityDefault('hook', 'pullSpeed', 20),
            missileRange: sharedAbilityDefault('missile', 'range', 36),
            missileDamage: sharedAbilityDefault('missile', 'damage', 70),
            missileRadius: sharedAbilityDefault('missile', 'radius', 2.0),
            missileTravelSpeed: sharedAbilityDefault('missile', 'travelSpeed', 34),
            missileAcquireRange: sharedAbilityDefault('missile', 'acquireRange', 6.0),
            missileCatchRadius: sharedAbilityDefault('missile', 'catchRadius', 1.1),
            missileLockHalfAngleDeg: sharedAbilityDefault('missile', 'lockHalfAngleDeg', 10),
            missileHomingBoost: sharedAbilityDefault('missile', 'homingBoost', 4.5),
            missileHomingLerp: sharedAbilityDefault('missile', 'homingLerp', 6.0),
            healDuration: sharedAbilityDefault('heal', 'duration', 1.0),
            healAmount: sharedAbilityDefault('heal', 'healAmount', 90),
            deadeyeLockBoxPx: 220,
            deadeyeLockRange: sharedAbilityDefault('deadeye', 'range', 60),
            deadeyeDuration: sharedAbilityDefault('deadeye', 'duration', 1.6),
            deadeyeMaxTargets: sharedAbilityDefault('deadeye', 'maxTargets', 2),
            deadeyeDamage: sharedAbilityDefault('deadeye', 'damage', 160)
        }
    };
    ...
    function buildBase() {
        ...
        return {
            ...
            classAbilities: {
                ...
                hookPullSpeed: Number.isFinite(Number(hook.pullSpeed)) ? Number(hook.pullSpeed) : DEFAULTS.classAbilities.hookPullSpeed,
