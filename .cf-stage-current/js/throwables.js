...
(function () {
    ...
    function updateTrajectoryPreviewVolumes(type, sim, previewColors) {
        ...
        if (type === 'frag') {
            var fragRadius = Math.max(0.1, Number(defs.frag && defs.frag.radius || throwableDistanceTuning.fragRadius || 1));
        ...
        if (type === 'molotov') {
            var fireRadius = Math.max(0.1, Number(defs.molotov && defs.molotov.fireRadius || throwableDistanceTuning.molotovFireRadius || 1));
    ...
    function updateTrajectoryPreview(type, intent) {
        ...
        updateTrajectoryPreviewVolumes(type, sim, previewColors);
