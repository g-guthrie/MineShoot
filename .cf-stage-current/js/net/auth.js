...
(function () {
    ...
    function formatClassName(classId) {
        return String(classId || 'default').replace(/[_-]+/g, ' ').toUpperCase();
    }
    ...
    function renderProfileSummary() {
        ...
        if (profileClass) profileClass.textContent = formatClassName(profile.classId || summaryUser.classId || 'default');
