...
(function () {
    ...
    function buildHomePage(data) {
        ...
        lines.push('  1. Choose top tab (Controls / Weapons / Throwables / etc).');
        lines.push('  2. For Weapons and Throwables, choose a subpage from left list.');
    ...
    function buildControlsPage() {
        return [
            ...
            '  Q: Throwable (hold for preview, release to throw)',
            '',
            'Utility',
    ...
    function buildFormulasPage() {
        return [
            ...
            'Weapon, enemy, radar, and throwable range values',
