...
export const gameplayTuning = {
  ...
  network: {
    ...
    selfReconciliation: {
      ...
      movingBlendDistanceWu: 0.85,
      movingBlendVerticalWu: 0.55,
      movingCorrectionDecayMs: 180,
      idleReplayDistanceWu: 0.85,
      movingReplayDistanceWu: 1.65,
      replayBlendDistanceWu: 4.5,
      replayBlendVerticalWu: 1.2,
      replayCorrectionDecayMs: 260,
      emergencyReplayDistanceWu: 2.6,
      baseGraceMs: 140,
      maxExtraGraceMs: 140,
      movingAckDriftLimit: 5,
      airborneHardSnapDistanceWu: 6.25,
      airborneHardSnapVerticalWu: 2.75,
      airborneReplayDistanceWu: 2.4,
      airborneGraceMs: 200,
    ...
    remoteInterpolation: {
      ...
      minDelayMs: 64,
      maxDelayMs: 180,
      intervalDelayScale: 1.55,
      jitterDelayScale: 2.0,
      delayIncreaseTargetWeight: 0.72,
      delayDecreaseTargetWeight: 0.12,
      freezeGapMinMs: 80,
      freezeGapMaxMs: 240,
      freezeGapIntervalScale: 2.0,
      freezeGapJitterScale: 2.8,
      freezeRecoveryBlendMs: 80,
      maxExtrapolationMinMs: 4,
      maxExtrapolationMaxMs: 22,
      maxExtrapolationIntervalScale: 0.18,
      maxExtrapolationJitterScale: 0.3,
      extrapolationDecay: 1.4,
      verticalBallisticEnabled: true,
      presentationClockCatchupScale: 1.15,
      ...
      lossDelayPaddingIntervalScale: 1.25,
